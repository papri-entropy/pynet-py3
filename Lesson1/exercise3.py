...
first_variable = "2001::1:2:3:4"
SECOND_VARIABLE = "2001::1:2:3:4"
Variable_3 = "2001::1:2:3:4"

print(first_variable == SECOND_VARIABLE)
print(first_variable != Variable_3)

print()
print("Is variable1 equal to variable2: {}".format(first_variable == SECOND_VARIABLE))
print("Is variable1 not equal to variable3: {}".format(first_variable != Variable_3))
print()